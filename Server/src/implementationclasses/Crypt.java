...
public class Crypt {
     ...
     */
    public static void getDESKey (byte[] key){
     ...
     */
    public static String decryptRSA(byte[] text)
    {
        byte[] bytetext = text;
     ...
     */
    static PrivateKey restoreRSAPrivateKEy() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException
    {
