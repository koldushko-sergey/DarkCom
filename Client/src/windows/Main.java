...
public class Main extends Application {
    ...
    public void start(Stage primarySTage) throws Exception{
        ...
        loginStage.setTitle("Авторизация - DarkCom © 2017");
        loginStage.initStyle(StageStyle.TRANSPARENT);
        LoginWindowController loginController = loginLoader.getController();
        loginController.Initialization(loginStage, ws);
        ...
        mainStage.setTitle("DarkCom © 2017");
        mainStage.initStyle(StageStyle.TRANSPARENT);
        MainWindowController mainController = mainLoader.getController();
        mainController.Initialization(mainStage, ws);
